...
const About = () => {
  ...
  return(
    <div>
      <div>
        <div>
          <Image src="/Rectangle66.png" width={500} height={500} className="w-[100%]" alt="Rec"/>
        </div>
        ...
        <div>
          ...
          <div className="w-[100%] flex items-center gap-5 mission">
            <Image src="/Rectangle27.png" width={500} height={500} className="w-[40%]" alt="Rec"/>
      ...
      <div>
        <div className="w-[100%] flex items-center gap-5 story">
            ...
            <Image src="/Rectangle69.png" width={500} height={500} className="w-[40%]" alt="Rect"/>
        </div>
        <div className="meet-our">
          ...
          <div className="flex flex-col items-center gap-10">
            <div className="flex items-center gap-5">
              <div>
                <Image src="/Rectangle63.png" width={500} height={500} className="" alt="Rec"/>
              ...
              <div>
                <Image src="/Rectangle57.png" width={500} height={500} className="" alt="Rec"/>
                <div className="team-text">
                  <h1>Heritage John</h1>
                  <p>Product Manager</p>
                </div>
              ...
              <div>
                <Image src="/Rectangle37.png" width={500} height={500} className="" alt="Rec"/>
                <div className="team-text">
              ...
              <div>
                <Image src="/Rectangle7-3.png" width={500} height={500} className="" alt="Rec"/>
                <div className="team-text">
            ...
            <div className="flex items-center gap-5">
              <div>
                <Image src="/Rectangle53.png" width={500} height={500} className="" alt="Rec"/>
                <div className="team-text">
                  <h1>Tobi Williams</h1>
              ...
              <div>
                <Image src="/Rectangle5-4.png" width={500} height={500} className="" alt="Rec"/>
                <div className="team-text">
              ...
              <div>
                <Image src="/Rectangle6-5.png" width={500} height={500} className="" alt="Rec"/>
                <div className="team-text">
              ...
              <div>
                <Image src="/Rectangle6-6.png" width={500} height={500} className="" alt="Rec"/>
                <div className="team-text">
                  <h1>Joy Akpan</h1>
